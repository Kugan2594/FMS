    ...
    <Card className="small-card" onClick={cardOnClick}>
      <Row className="main-row" justify="center" align="top" gutter={8}>
        <Col xs={24} xl={4}>
          ...
          {isProgressBar && <Progress percent={progressData} size="small" />}
        </Col>
        <Col
          xs={24}
          xl={9}
        ...
        >
          <div className="content-2-item">
            ...
            {adminCard && <Title level={5}> {adminFirstName}</Title>}
            {vehicleCard && <Title level={5}> {vehicleNumber}</Title>}
            {generatorCard && (
              <Title style={{ fontSize: "18px", marginBottom: "5%" }} level={5}>
                {" "}
                {generatorName}
              </Title>
            )}
        ...
        <Col xs={24} xl={11}>
          <Row justify="end" className="content-3" align="bottom">
            ...
            <div className="actions">
              {privilege && (
                <SettingOutlined style={{ fontSize: "24px", opacity: "0.5" }} />
              )}
              <Button
                ...
                onClick={
                  vehicleCard
                    ? () => {
                        onClickVehicleDelete(vehicleNumber);
                      }
                    : () => {
                        onClickDelete(id);
                      }
